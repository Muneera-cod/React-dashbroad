...
function Invoicelist() {
  ...
  return (
    <div className='bg-slate-200 min-w-screen min-h-screen  flex '>
           <div className='w-full  flex flex-col  p-5 bg-slate-200'>
              ...
              <div className='flex flex-col w-full h-full bg-slate-200 gap-2'>  
                <div className='flex  w-full bg-slate-200 h-14 w-full rounded Items-center px-5 overflow-auto'>
                        <div className='flex items-center basis-1/6 gap-3 min-w-32'>
                        ...
                        <div className='flex items-center p-4 gap-6 basis-2/6 min-w-32'>
                        ...
                        <div className='flex items-center basis-2/6 p-4 gap-6 min-w-32'>
                ...
                {invoicelistdata.map((items)=>{
                   return(
                <div className='flex  w-full bg-white h-14 focus:ring-violet-300 w-full rounded-lg Items-center px-5 overflow-auto scroll '>
                        <div className='flex items-center basis-1/6 min-w-32'>
                          <div className='flex gap-3'> 
                            <label className='flex items-center'><input type='checkbox' className='size-5 accent-indigo-500 border-gray-200 '></input></label>
                            <p>{items.id}</p>
                          </div>  
                        </div>
                        <div className='flex items-center basis-2/6 min-w-40'>
                            <div className='flex gap-3'>
                                <img src={profile} className='size-8  rounded-full'></img>
                                <p>{items.name}</p>
                            </div>       
                        </div>
                        <div className='flex items-center basis-2/6 min-w-60'>
                            <div className='flex gap-3'>
                                {items.emailicon}
                                <p>{items.email}</p>
                            </div>
                        </div>
                        <div className='flex items-center basis-2/6 min-w-32'>
                            <div className='flex gap-3'>
                               {items.dateicon}
                                <p>{items.date}</p>
                            </div>
                        </div>
                        <div className='flex items-center basis-2/6 px-4'>
                        {items.complete?
                           <div className='flex gap-3'>
